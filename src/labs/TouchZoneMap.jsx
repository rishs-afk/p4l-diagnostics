    ...
    >
      {state === 'idle' && (
        <div className="space-y-3">
          <p className="text-xs text-charcoal-muted">Swipe across the entire screen to verify all touch zones are responsive.</p>
      ...
      {state === 'testing' && (
        <div className="space-y-3">
          ...
          <div
            ref={containerRef}
            className="grid gap-[2px] rounded-xl overflow-hidden touch-none select-none"
            style={{
          ...
          <button onClick={handleFinish} className="btn-secondary" id="touchzone-finish-btn">
